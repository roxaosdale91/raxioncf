namespace GameCreator.Melee
{
	...
	public class MeleeWeaponEditor : IMeleeEditor
	{
        ...
        private SerializedProperty spKnockupReaction;
        private SerializedProperty spStunReaction;
        ...
        private ReorderableList knockupReaction;
        private ReorderableList stunReaction;
        ...
        private void OnEnable()
        {
            ...
            spKnockupReaction               = this.serializedObject.FindProperty("knockupReaction");

            spStunReaction               = this.serializedObject.FindProperty("stunReaction");
            ...
            //############# knockup ###################
            this.knockupReaction = new ReorderableList(
                this.serializedObject,
                this.spKnockupReaction,
                true, true, true, true
            );

            //############# stun ###################
            this.stunReaction = new ReorderableList(
                this.serializedObject,
                this.spStunReaction,
                true, true, true, true
            );
            ...
            knockupReaction                     .drawHeaderCallback  += this.PaintHitKnockup_Title;

            stunReaction                        .drawHeaderCallback  += this.PaintHitStun_Title;
            ...
            knockupReaction                     .drawElementCallback  += this.PaintHitKnockup_Element;

            stunReaction                        .drawElementCallback  += this.PaintHitStun_Element;
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            knockupReaction.DoLayoutList();

            EditorGUILayout.Space();
            stunReaction.DoLayoutList();
        ...
        private void PaintHitKnockup_Title(Rect rect)
        {
            EditorGUI.LabelField(rect, "Hit Reaction - Knockup");
        }

        private void PaintHitStun_Title(Rect rect)
        {
            EditorGUI.LabelField(rect, "Hit Reaction - Stun");
        }
        ...
        private void PaintHitKnockup_Element(Rect rect, int index, bool isActive, bool isFocused)
        {
            ...
            EditorGUI.PropertyField(
                rect, this.spKnockupReaction.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }

        //Elements --- stun
        private void PaintHitStun_Element(Rect rect, int index, bool isActive, bool isFocused)
        {
            rect = new Rect(
                rect.x, rect.y + (rect.height - EditorGUIUtility.singleLineHeight) / 2f,
                rect.width, EditorGUIUtility.singleLineHeight
            ...
            EditorGUI.PropertyField(
                rect, this.spStunReaction.GetArrayElementAtIndex(index),
                GC_REACTION, true
            );
        }
