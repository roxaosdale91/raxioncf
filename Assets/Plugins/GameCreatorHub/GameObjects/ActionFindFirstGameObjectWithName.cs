namespace GameCreator.Core
{
    ...
    [AddComponentMenu("")]
    public class ActionFindFirstGameObjectWithName : IAction
    {
        ...
        [Header("Find First GameObject of those with specified Name.")]
        [Space(10)]
        ...
        [Space(20)]
        [Header("First GameObject found with that Name...  returns a NULL if none found.")]
        ...
        #if UNITY_EDITOR
        public static new string NAME = "Custom/GameObjects/ActionFindFirstGameObjectWithName";
        #endif
    }
}
