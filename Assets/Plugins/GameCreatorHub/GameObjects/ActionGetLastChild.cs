namespace GameCreator.Core
{
    ...
    [AddComponentMenu("")]
    public class ActionGetLastChild : IAction
    {
        [Header("Select GameObject to get Last Child from.")]
        ...
        public override bool InstantExecute (GameObject target, IAction[] actions, int index)
        {
            ...
            {
                childtrans = GO.transform.GetChild(GO.transform.childCount-1);
...
#if UNITY_EDITOR
        public static new string NAME = "Custom/GameObjects/ActionGetLastChild";
        #endif
    }
