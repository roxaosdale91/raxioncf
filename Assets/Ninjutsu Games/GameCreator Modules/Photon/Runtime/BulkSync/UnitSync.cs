...
namespace NJG.PUN.BulkSync
{
    public class UnitSync : MonoBehaviour
    {
        ...
        public void Synchronize()
        {
            ...
            transform.localPosition = Vector3.LerpUnclamped(m_onUpdatePos, m_latestCorrectPos, m_fraction);
            transform.rotation = Quaternion.Slerp(transform.rotation, Quaternion.Euler(m_newRot),
                    2 * Time.deltaTime);
        }
